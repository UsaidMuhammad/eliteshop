...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    {{Form::open(["url"=>"/admin/women/".$CategoryID."/products/delete/"])}}
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('admin/women/'.$CategoryID.'/products/add')}}" class="btn btn-primary pull-right">Add New</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @if(count($products)>0)
                  @foreach($products as $item)
                      <tr>
                        <td><input type="checkbox" name="IDs[]" value="{{ $item->ProductID }}" class="lowercheckbox"></td>
                        ...
                        <td><a href="{{url('admin/women/').'/'. $CategoryID.'/products/'.$item->ProductID.'/edit'}}" class="btn btn-danger">Edit</a></td>
                      </tr> 
                  @endforeach   
                @endif
