		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li>
						<a href="{{url('admin/women/category/list')}}">
							<i class="fa fa-user"></i>Men</a>
					</li>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-primary">
							...
							{{Form::open(["url"=>"/admin/women/category/".$women->CategoryID.'/edit'])}}
							<div class="box-body">
								...
								<div class="form-group">
									...
									{{Form::text('CategoryName', $women->CategoryName, ['class'=>"form-control"])}}
								</div>
								<div class="form-group">
