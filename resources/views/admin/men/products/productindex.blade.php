        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('admin/men/'.$CategoryID.'/products/add')}}" class="btn btn-primary pull-right">Add New</a>
                ...
                @if(count($products)>0)
                  @foreach($products as $item)
                      <tr>
                        ...
                        <td><a href="{{url('admin/men/').'/'. $CategoryID.'/products/'.$item->ProductID.'/edit'}}" class="btn btn-danger">Edit</a></td>
                      </tr> 
                  @endforeach   
                @endif
