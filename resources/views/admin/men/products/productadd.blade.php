		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li>
						<a href="{{url('admin/men/'.$CategoryID.'/products/list')}}">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-primary">
							...
							{{Form::open(["url"=>"/admin/men/".$CategoryID."/products/add","files"=>true])}}
							<div class="box-body">
								...
								<div class="form-group">
									...
									<label>
										<input type="radio" name="status" class="minimal" checked value="1"> Active
									</label>
									<label>
