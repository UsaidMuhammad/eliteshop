...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    {{Form::open(["url"=>"/admin/men/cateogry/delete/"])}}
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('admin/men/category/add')}}" class="btn btn-primary pull-right">Add New</a>
                ...
                @if(count($men)>0)
                  @foreach($men as $item)
                      <tr>
                        ...
                        <td><a href="{{url('admin/men/category').'/'. $item->CategoryID.'/edit'}}" class="btn btn-danger">Edit</a></td>
                      </tr> 
                  @endforeach   
                @endif
