...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    {{Form::open(["url"=>"/admin/users/delete/"])}}
    <!-- Main content -->
                ...
                @if(count('users')>0)
                  @foreach($users as $item)
                      <tr>
                        ...
                        <td><a href="{{url('admin/users/edit/').'/'. $item->UserID}}" class="btn btn-danger">Edit</a></td>
                        <td><a href="{{url('admin/users/pass/').'/'. $item->UserID}}" class="btn btn-warning">Change</a></td>
                      </tr> 
                  @endforeach   
                @endif
