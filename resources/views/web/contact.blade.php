   ...
   <!--/contact-->
    <div class="banner_bottom_agile_info">
				...
				<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="{{url('/assets/web')}}/mailto:info@example.com">info@example1.com</a><span><a href="{{url('/assets/web')}}/mailto:info@example.com">info@example2.com</a></span></p>
						</div>
					</div>
	   ...
	   <div class="contact-w3-agile1 map" data-aos="flip-right">
		   ...
		   <iframe src="{{url('/assets/web')}}/https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100949.24429313939!2d-122.44206553967531!3d37.75102885910819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1472190196783" class="map" style="border:0" allowfullscreen=""></iframe>
	   </div>
   <div class="banner_bottom_agile_info">
	<div class="container">
					...
					<div class="col-md-6 address-grid">
						<h4>For More <span>Information</span></h4>
							...
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="{{url('/assets/web')}}/mailto:info@example.com">info@example.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
