...
@include("web/includes/breadcrum", $title)
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/d2.jpg">
							<div class="thumb-image"> <img src="{{url('/assets/web')}}/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">PKR 650</span></p>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{url('/assets/web')}}/images/t1.jpg" alt=" " class="img-responsive">
										</div>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="{{url('/assets/web')}}/index.html"><span>E</span>lite Shoppy </a></h2>
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						<li><a href="{{url('/assets/web')}}/index.html">Home</a></li>
						<li><a href="{{url('/assets/web')}}/mens.html">Men's Wear</a></li>
						<li><a href="{{url('/assets/web')}}/womens.html">Women's wear</a></li>
						<li><a href="{{url('/assets/web')}}/about.html">About</a></li>
						<li><a href="{{url('/assets/web')}}/typography.html">Short Codes</a></li>
						<li><a href="{{url('/assets/web')}}/contact.html">Contact</a></li>
					</ul>
				</div>
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="{{url('/assets/web')}}/mailto:example@email.com"> mail@example.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="{{url('/assets/web')}}/single.html"><img src="{{url('/assets/web')}}/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
		...
		<p class="copy-right">&copy 2017 Elite shoppy. All rights reserved | Design by <a href="{{url('/assets/web')}}/http://w3layouts.com/">W3layouts</a></p>
	</div>
</div>
<!-- //footer -->
